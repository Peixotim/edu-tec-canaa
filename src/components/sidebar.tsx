            ...
            <div className="flex items-center justify-between py-2">
              ...
              >
                <div className="relative w-32 h-16 sm:w-40 sm:h-20">
                  <Image
                    src="/images/semFoto.png"
                    alt="EduTec Canaa Logo"
                    fill
              ...
              <ul className="hidden lg:flex gap-8 font-semibold text-base">
                {menuItems.map((item) => (
                  <li key={item.name}>
                    <Link
                      href={item.href}
                      className="relative text-[#6A0E29]/80 hover:text-[#6A0E29] transition-colors duration-300 after:absolute after:left-0 after:-bottom-1 after:h-[3px] after:w-0 after:bg-[#8B1A3B] after:rounded-full after:transition-all after:duration-300 hover:after:w-full"
                    >
                      {item.name}
                    </Link>
                  </li>
              ...
              <div className="hidden lg:flex">
                <Button
                  onClick={openModal}
                  className="rounded-full bg-[#8B1A3B] text-white hover:bg-[#6A0E29] px-6 py-5 shadow-lg font-bold transition-all hover:scale-105"
                >
